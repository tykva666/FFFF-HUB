...
local function AutoFuncDepositHoney()
    while Config.Settings.ToggleAutoDepositHoney do
        local RemoteEvent = ReplicatedStorage.Framework.Features.HoneySystem.GameEventUtil.RemoteEvent -- RemoteEvent 
...
local function AutoFuncSell()
    while Config.Settings.ToggleAutoSell do
        local RemoteEvent = ReplicatedStorage.Framework.Features.HoneySystem.HoneyUtil.RemoteEvent -- RemoteEvent 
